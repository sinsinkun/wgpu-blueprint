// note: all uv_y coords are inverted
use super::*;
...
impl Shape {
  pub fn new(renderer: &mut Renderer, pipeline_id: RId, vertex_data: Vec<RVertex>, index_data: Option<Vec<u32>>) -> Self {
  ...
  pub fn new_anim(renderer: &mut Renderer, pipeline_id: RId, vertex_data: Vec<RVertexAnim>, index_data: Option<Vec<u32>>) -> Self {
    let mut setup = RObjectSetup {
      pipeline_id: pipeline_id.pipeline,
